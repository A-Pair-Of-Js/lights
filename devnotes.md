...
Decided to try Vitest for the first time. I've previously used Jest but the lightweight and purportedly speedy Vitest with hot reloading re-running only changed code and affected tests looked worth exploring.
