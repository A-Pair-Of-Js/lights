...
const backgroundStyles: Record<LightColour, string> = {
  red: "repeating-linear-gradient(to right, rgb(255,0,0) 0 8px, rgb(150,0,0) 8px 16px)", 
  orange: "repeating-linear-gradient(to bottom, rgb(255,140,0) 0 8px, rgb(255,200,0) 8px 16px)", 
  green: "rgb(0,128,0)"
};
